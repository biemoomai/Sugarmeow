...
export default function TopNav() {
  ...
  return (
    <div className="sticky top-0 z-40 bg-[#F8FAFC]/80 backdrop-blur-xl border-b border-slate-200/50 pt-4 pb-3 px-4 flex items-center justify-between gap-3">
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex-1 text-center py-1.5 rounded-lg text-[13px] font-bold transition-all relative ${
